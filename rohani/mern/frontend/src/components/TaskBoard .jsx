...
const TaskDetailModal = ({ task, onClose }) => (
  <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
      ...
      <button
        onClick={onClose}
        className="mt-4 bg-emerald-600 text-white px-4 py-2 rounded-md shadow-sm"
      >
        Close
      </button>
    </div>
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="flex justify-end">
          <button
            onClick={handleSave}
            className="bg-emerald-600 text-white px-4 py-2 rounded-md mr-2 shadow-sm"
          >
            Save
          </button>
          <button
...
const TrelloBoard = () => {
  ...
  const onDragEnd = async (result) => {
    ...
    try {
      const response = await apiClient.put(`/tasks/${task.id}`, updatedTask);
        ...
        <div className="flex flex-col md:flex-row gap-4">
          {Object.values(filteredColumns).map((column) => (
            <div key={column.id} className="flex-1 min-w-[250px]">
              <h2 className="font-bold mb-2 bg-slate-800 text-white p-2 rounded">
                {column.title}
              </h2>
              <Droppable droppableId={column.id}>
                {(provided) => (
                  <div
                    ...
                    className="bg-slate-100 p-2 rounded min-h-[100px]"
                  >
